...
#                        z_level = 1
        ...
        # base core + outgroup
        key_box = Rectangle ((key_x_margin, 1.0-(key_y_margin+1*key_line_spacing)), box_w, box_h facecolor=base_univ_color, edgecolor="gray", alpha=1.0, zorder=1)
        ...
        key_box = Rectangle ((key_x_margin, 1.0-(key_y_margin+2*key_line_spacing)), box_w, box_h facecolor=base_core_color, edgecolor="gray", alpha=1.0, zorder=1)
        ax.add_patch(key_box)
        ...
        key_box = Rectangle ((key_x_margin, 1.0-(key_y_margin+3*key_line_spacing)), box_w, box_h facecolor=base_partial_color, edgecolor="gray", alpha=1.0, zorder=1)
        ax.add_patch(key_box)
        ...
        # base singletons
        key_box = Rectangle ((key_x_margin, 1.0-(key_y_margin+4*key_line_spacing)), box_w, box_h facecolor=base_singleton_color, edgecolor="gray", alpha=1.0, zorder=1)
        ax.add_patch(key_box)
        ...
        # pan core + outgroup
        key_box = Rectangle ((key_x_margin, 1.0-(key_y_margin+6.5*key_line_spacing)), box_w, box_h facecolor=hit_univ_color, edgecolor="gray", alpha=1.0, zorder=1)
        ax.add_patch(key_box)
        ...
        key_box = Rectangle ((key_x_margin, 1.0-(key_y_margin+7.5*key_line_spacing)), box_w, box_h facecolor=hit_core_color, edgecolor="gray", alpha=1.0, zorder=1)
        ax.add_patch(key_box)
        ...
        key_box = Rectangle ((key_x_margin, 1.0-(key_y_margin+8.5*key_line_spacing)), box_w, box_h facecolor=hit_partial_color, edgecolor="gray", alpha=1.0, zorder=1)
        ax.add_patch(key_box)
