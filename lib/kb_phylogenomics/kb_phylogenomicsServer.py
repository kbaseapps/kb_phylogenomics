...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_phylogenomics'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_phylogenomics.kb_phylogenomicsImpl import kb_phylogenomics  # noqa @IgnorePep8
impl_kb_phylogenomics = kb_phylogenomics(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_phylogenomics'
        ...
        self.rpc_service.add(impl_kb_phylogenomics.trim_species_tree_to_genomeSet,
                             name='kb_phylogenomics.trim_species_tree_to_genomeSet',
                             types=[dict])
        self.method_authentication['kb_phylogenomics.trim_species_tree_to_genomeSet'] = 'required'  # noqa
