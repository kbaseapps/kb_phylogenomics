...
public class ViewFxnProfileInput {
    ...
    public ViewFxnProfileInput withGenomeDispNameConfig(String genomeDispNameConfig) {
        this.genomeDispNameConfig = genomeDispNameConfig;
        return this;
    }
    ...
    public ViewFxnProfileInput withRequiredCOGAnnotPerc(Double requiredCOGAnnotPerc) {
        this.requiredCOGAnnotPerc = requiredCOGAnnotPerc;
        return this;
    }
    ...
    public ViewFxnProfileInput withRequiredPFAMAnnotPerc(Double requiredPFAMAnnotPerc) {
        this.requiredPFAMAnnotPerc = requiredPFAMAnnotPerc;
        return this;
    }
    ...
    public ViewFxnProfileInput withRequiredTIGRAnnotPerc(Double requiredTIGRAnnotPerc) {
        this.requiredTIGRAnnotPerc = requiredTIGRAnnotPerc;
        return this;
    }
    ...
    public ViewFxnProfileInput withRequiredSEEDAnnotPerc(Double requiredSEEDAnnotPerc) {
        this.requiredSEEDAnnotPerc = requiredSEEDAnnotPerc;
        return this;
    }
    ...
    public ViewFxnProfileInput withCountHypothetical(Long countHypothetical) {
        this.countHypothetical = countHypothetical;
        return this;
    }
    ...
    public String toString() {
        return ((((((((((((((((((((((((((((((((((((((((("ViewFxnProfileInput"+" [workspaceName=")+ workspaceName)+", inputGenomeSetRef=")+ inputGenomeSetRef)+", namespace=")+ namespace)+", customTargetFams=")+ customTargetFams)+", genomeDispNameConfig=")+ genomeDispNameConfig)+", countCategory=")+ countCategory)+", heatmap=")+ heatmap)+", vertical=")+ vertical)+", topHit=")+ topHit)+", eValue=")+ eValue)+", logBase=")+ logBase)+", requiredCOGAnnotPerc=")+ requiredCOGAnnotPerc)+", requiredPFAMAnnotPerc=")+ requiredPFAMAnnotPerc)+", requiredTIGRAnnotPerc=")+ requiredTIGRAnnotPerc)+", requiredSEEDAnnotPerc=")+ requiredSEEDAnnotPerc)+", countHypothetical=")+ countHypothetical)+", showBlanks=")+ showBlanks)+", skipMissingGenomes=")+ skipMissingGenomes)+", enforceGenomeVersionMatch=")+ enforceGenomeVersionMatch)+", additionalProperties=")+ additionalProperties)+"]");
    }
