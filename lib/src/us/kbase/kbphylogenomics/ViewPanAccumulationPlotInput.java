...
/**
 * <p>Original spec-file type: view_pan_accumulation_plot_Input</p>
 * <pre>
...
public class ViewPanAccumulationPlotInput {
    ...
    public ViewPanAccumulationPlotInput withWorkspaceName(String workspaceName) {
        this.workspaceName = workspaceName;
        return this;
    }
    ...
    public ViewPanAccumulationPlotInput withInputGenomeRef(String inputGenomeRef) {
        this.inputGenomeRef = inputGenomeRef;
        return this;
    }
    ...
    public ViewPanAccumulationPlotInput withInputPangenomeRef(String inputPangenomeRef) {
        this.inputPangenomeRef = inputPangenomeRef;
        return this;
    }
    ...
    public String toString() {
        return ((((((((("ViewPanAccumulationPlotInput"+" [workspaceName=")+ workspaceName)+", inputGenomeRef=")+ inputGenomeRef)+", inputPangenomeRef=")+ inputPangenomeRef)+", additionalProperties=")+ additionalProperties)+"]");
    }
