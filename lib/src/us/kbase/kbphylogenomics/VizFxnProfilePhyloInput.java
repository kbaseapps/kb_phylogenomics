...
/**
 * <p>Original spec-file type: viz_fxn_profile_phylo_Input</p>
 * <pre>
 * viz_fxn_profile_phylo()
 * **
...
public class VizFxnProfilePhyloInput {
    ...
    public VizFxnProfilePhyloInput withWorkspaceName(String workspaceName) {
        this.workspaceName = workspaceName;
        return this;
    }
    ...
    public VizFxnProfilePhyloInput withInputGenomeSetRef(String inputGenomeSetRef) {
        this.inputGenomeSetRef = inputGenomeSetRef;
        return this;
    }
    ...
    public VizFxnProfilePhyloInput withInputSpeciesTreeRef(String inputSpeciesTreeRef) {
        this.inputSpeciesTreeRef = inputSpeciesTreeRef;
        return this;
    }
    ...
    public String toString() {
        return ((((((((("VizFxnProfilePhyloInput"+" [workspaceName=")+ workspaceName)+", inputGenomeSetRef=")+ inputGenomeSetRef)+", inputSpeciesTreeRef=")+ inputSpeciesTreeRef)+", additionalProperties=")+ additionalProperties)+"]");
    }
