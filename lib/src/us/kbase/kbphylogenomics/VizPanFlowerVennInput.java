...
/**
 * <p>Original spec-file type: viz_pan_flower_venn_Input</p>
 * <pre>
 * viz_pan_flower_venn()
 * **
...
public class VizPanFlowerVennInput {
    ...
    public VizPanFlowerVennInput withWorkspaceName(String workspaceName) {
        this.workspaceName = workspaceName;
        return this;
    }
    ...
    public VizPanFlowerVennInput withInputGenomeRef(String inputGenomeRef) {
        this.inputGenomeRef = inputGenomeRef;
        return this;
    }
    ...
    public VizPanFlowerVennInput withInputPangenomeRef(String inputPangenomeRef) {
        this.inputPangenomeRef = inputPangenomeRef;
        return this;
    }
    ...
    public String toString() {
        return ((((((((("VizPanFlowerVennInput"+" [workspaceName=")+ workspaceName)+", inputGenomeRef=")+ inputGenomeRef)+", inputPangenomeRef=")+ inputPangenomeRef)+", additionalProperties=")+ additionalProperties)+"]");
    }
