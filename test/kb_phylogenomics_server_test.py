...
#                                                  })[0]
    ...
    def test_run_DomainAnnotation_Sets_01(self):
        method = 'test_run_DomainAnnotation_Sets_01'
        msg = "RUNNING: "+method+"()"
        print ("\n\n"+msg)
        print ("="*len(msg)+"\n\n")
...
#        genome_ref_3 = self.getWsName() + '/' + str(genomeInfo_3[0]) + '/' + str(genomeInfo_3[4])
    ...
    def test_view_fxn_profile_01(self):
        method = 'test_view_fxn_profile_01'
        msg = "RUNNING: "+method+"()"
        print ("\n\n"+msg)
        print ("="*len(msg)+"\n\n")
...
#        domain_info_3 = self.getDomainInfo('Wolbachia_sp.wRi.Domains', 3, genome_ref_3)
    ...
    def test_view_fxn_profile_featureSet_01(self):
        method = 'test_view_fxn_profile_featureSet_01'
        msg = "RUNNING: "+method+"()"
        print ("\n\n"+msg)
        print ("="*len(msg)+"\n\n")
...
#        domain_info_3 = self.getDomainInfo('Wolbachia_sp.wRi.Domains', 3, genome_ref_3)
    ...
    def test_view_fxn_profile_phylo_01(self):
        method = 'test_view_fxn_profile_phylo_01'
        msg = "RUNNING: "+method+"()"
        print ("\n\n"+msg)
        print ("="*len(msg)+"\n\n")
    ...
    def test_view_pan_circle_plot_01(self):
        method = 'test_view_pan_circle_plot_01'
        msg = "RUNNING: "+method+"()"
        print ("\n\n"+msg)
        print ("="*len(msg)+"\n\n")
    ...
    def test_trim_species_tree_to_genomeSet_01(self):
                                                    ...
                                                    'objects': [
                                                        {
                                                            ...
                                                            'provenance':[
                                                                {
                                                                    'service':'kb_phylogenomics',
                                                                    'method':'test_trim_tree_to_genomeSet'
                                                                }
                                                            ]
                                                        }]
                                                })[0]
        ...
        # run that sucker
        obj_out_name = 'trimmed_tree.Tree'
        ...
        ret = self.getImpl().trim_tree_to_genomeSet(self.getContext(),params)[0]
        self.assertIsNotNone(ret['report_ref'])
